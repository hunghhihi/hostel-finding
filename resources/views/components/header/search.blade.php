        ...
        <div class="flex items-center">
            <div x-data="{
                ...
                <button @click="notify = !notify"
                    class="flex h-10 w-10 items-center justify-center rounded-full bg-primary-500">
                    <x-heroicon-o-bell class="h-5 w-5 text-white" />
                </button>
                <div x-cloak x-show="notify" @click.away="notify = false" style="height: 600px"
                    class="absolute right-0 z-50 mt-2 w-80 origin-top-right divide-y divide-gray-200 overflow-auto rounded-md border border-gray-200 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <livewire:notify />
                </div>
            </div>
            {{-- menu & dropdown --}}
            <div x-data="{
                ...
                <div x-cloak x-show="show" @click.outside="show = false" x-transition
                    ...
                    @auth
                        ...
                        <a href="{{ route('hostels.create') }}" class="block px-4 py-2 text-sm text-gray-700"
                            role="menuitem" tabindex="-1" id="user-menu-item-0">Đăng tin</a>
                        ...
                        <a href="{{ route('hostels.manage') }}" class="block px-4 py-2 text-sm text-gray-700"
                            role="menuitem" tabindex="-1" id="user-menu-item-0">Quản lý nhà trọ</a>
