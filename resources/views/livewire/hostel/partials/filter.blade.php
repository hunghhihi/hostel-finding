<div
    x-data="livewire_hostel_partials_filter"
    wire:ignore
>
    {{-- action to show --}}
    <button
        class="flex items-center gap-1 rounded-lg border p-2 text-center hover:shadow"
        @click="show = !show"
    >
        <svg
                ...
                <div class="table h-full">
                        ...
                        <div class="h-full space-y-8 overflow-auto p-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <button
                                        class="rounded-xl px-4 py-2 text-lg"
                                        :class="{
                    ...
                    <div class="table-cell">
                        <div class="flex items-center justify-between border-t py-4 px-6">
                            <button
                                type="button"
                                class="-translate-x-4 rounded-md px-4 py-2 hover:bg-gray-100"
                                @click="refresh"
                            >
