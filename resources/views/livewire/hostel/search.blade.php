<div
    x-data="livewire_hostel_search"
    class="flex h-full flex-1 flex-col-reverse overflow-auto md:grid md:grid-cols-12"
>
    ...
    <div class="bg-white px-2 md:col-span-5 md:overflow-auto">
        <div @class(['hidden' => $hostels->total() === 0])>
            <div class="flex justify-between p-4">
                @if ($hostels->total() < 1000)
                    ...
                    <div
                        wire:loading.block
                        class="h-5 w-40 rounded-xl bg-slate-200"
                    >
                    </div>
                @else
                    <span
        ...
        <div @class(['py-12 px-6', 'hidden' => $hostels->total() !== 0])>
            ...
            <div
                wire:loading.block
                class="h-8 w-80 rounded-xl bg-slate-200"
            >
            </div>
            ...
            <div
                wire:loading.block
                class="mt-3 h-5 w-96 rounded-xl bg-slate-200"
            >
            </div>

            <div wire:loading.remove>
                <button
                    wire:click="showNearestHostels"
            ...
            <div
                wire:loading.block
                class="mt-6 h-[52px] w-[165px] rounded-xl bg-slate-200"
            >
            </div>
        </div>
    </div>
